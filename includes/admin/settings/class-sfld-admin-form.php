...
if (!class_exists('SFLD_Admin_Form', false)) : class SFLD_Admin_Form extends SFLD_Singleton
  {
    /**
    ...
    public function sfld_simple_admin_form_init(): void
    {
      ...
      add_settings_field(
        ...
        'sfld_simple_settings_input_text',
        // Field Title
        __('Text Input', 'sfldsimple'),
    ...
    public function sfld_simple_settings_checkbox_callback($args): void
    {
      ...
      $html = '<input type="checkbox" id="sfld_simple_settings_checkbox" name="sfld_simple_settings[checkbox]" value="1"' . checked(1, $checkbox, false) . '/>';
      $html .= '&nbsp;';
      $html .= '<label for="sfld_simple_settings_checkbox">' . $args['label'] . '</label>';
    ...
    public function sfld_simple_settings_radio_callback($args): void
    {
      ...
      $html = '<input type="radio" id="sfld_simple_settings_radio_one" name="sfld_simple_settings[radio]" value="1"' . checked(1, $radio, false) . '/>';
      $html .= ' <label for="sfld_simple_settings_radio_one">' . $args['option_one'] . '</label> &nbsp;';
      $html .= '<input type="radio" id="sfld_simple_settings_radio_two" name="sfld_simple_settings[radio]" value="2"' . checked(2, $radio, false) . '/>';
      $html .= ' <label for="sfld_simple_settings_radio_two">' . $args['option_two'] . '</label>';
    ...
    public function sfld_simple_settings_select_callback($args): void
    {
      ...
      $html = '<select id="sfld_simple_settings_options" name="sfld_simple_settings[select]">';
